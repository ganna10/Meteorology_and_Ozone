# analyse individual reactions of subgroups contributing to O3 production and consumption Budgets
...
tbl_df(d %>% filter(Run == "TD", NOx.Condition == "High-NOx", Temperature.C == 15))
