setwd("~/Documents//Analysis//2015_Meteorology_and_Ozone//WRF-output//radm2//Poland/")
library(ncdf4)
...
tbl_df(data.df)
write.table(data.df, file = "~/Documents//Analysis//2015_Meteorology_and_Ozone//WRF-output//radm2/poland.csv", sep = ",", quote = FALSE, row.names = FALSE)
