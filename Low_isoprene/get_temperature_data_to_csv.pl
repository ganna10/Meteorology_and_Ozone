...
# Version 0: Jane Coates 21/11/2015
...
foreach my $checkfile (@files) { 
    ...
    my ($nox_emission, $NOx, $temperature, $O3, $H2O2, $OH, $HO2, $HOx, $HCHO, $RO2NO2, $RONO2, $HNO3, $PAN) = extract_data($mechanism, $checkfile, \@variables);
