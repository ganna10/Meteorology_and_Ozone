...
my $base = "/media/Seagate/Model_Data/T_Independent_BVOCs/$mechanism/Temperature";
...
my $eqn = "/media/Seagate/Model_Data/T_Independent_BVOCs/$mechanism/Trials/Benelux/gas.eqn";
my $kpp = KPP->new($eqn);
